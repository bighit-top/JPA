...
class MemberJpaRepositoryTest {
    ...
    public void testMember() {
        Member member = new Member("memmberA");
    ...
    public void findByUsernameAndAgeGreaterThan() {
        ...
        List<Member> result = memberJpaRepository.findByUsernameAndAgeGreaterThan("m1", 15);
    ...
    public void testNamedQuery() {
        ...
        List<Member> result = memberJpaRepository.findByUsername("m1");
